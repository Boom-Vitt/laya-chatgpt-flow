...
**สถานะปัจจุบัน: จบที่ 1 คู่ตามคำขอผู้ใช้** ทั้งสองคลิปผ่าน QC แล้ว เผยแพร่เป็นผลสาธิตเชิงพรรณนา ไม่มีการติดตามโควตาหรือสร้างรอบเพิ่ม แผน 3 คู่ด้านล่างเก็บไว้เป็นวิธีทดลองเดิมเพื่อให้ตรวจที่มาได้ ไม่ใช่งานที่ยังต้องทำต่อ และยังไม่มีหลักฐานพอจะสรุปการประหยัดทั่วไป
...
คำสั่งข้างต้นเป็นตัวอย่างสำหรับแผนเดิม 6 รอบ การสาธิตที่เผยแพร่จริงใช้เพียง `runs/baseline-1 runs/hybrid-1` แล้วส่งออก [results/pair-1.json](../results/pair-1.json) โดยเติม provenance ที่ตรวจแล้ว ตัวรายงานยังเก็บเกณฑ์เดิมและคืนเปอร์เซ็นต์เป็น `null`; ไม่ลดเกณฑ์เพื่อทำให้คู่เดียวดูเหมือนผลการทดลองครบ 3 คู่
