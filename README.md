...
<a id="chat-to-video"></a>
## พิมพ์สั่งในแชตแล้วทำคลิปให้เลยไหม?

**ได้ หลังตั้งค่าครั้งแรกเรียบร้อย** — ติดตั้งเครื่องมือตามคู่มือ เปิด Chrome โปรไฟล์ทดสอบ ล็อกอิน Google Flow และเปิดโฟลเดอร์ repo นี้ใน **ChatGPT Desktop → Work locally** ให้เรียกคำสั่งในเครื่องได้ก่อน แชตหน้าเว็บทั่วไปไม่ได้เชื่อมไฟล์และ Chrome บนเครื่องให้อัตโนมัติ

จากนั้นพิมพ์โจทย์ทำคลิปปักตะกร้าภาษาไทยตาม [ข้อความตัวอย่างด้านล่าง](#quickstart) ได้เลย: ChatGPT เตรียมบทและ Prompt → Laya ช่วยกรอกและกดส่งงานบน Flow → ตัวรันดาวน์โหลดสองช็อตมาต่อเป็นคลิป 16 วินาที โดยใช้เครดิต Flow ตามเพดานที่ระบุ ถ้าเครดิตไม่พอให้หยุด

**บางขั้นตอนยังอาจต้องช่วยเอง** เช่น ล็อกอิน ตั้งค่า Flow หรือเปิดเมนูที่ตัวรันยังจัดการไม่ได้ หากหน้าเว็บเปลี่ยนหรือ Laya ทำต่อไม่ได้ ระบบจะส่งกลับให้ ChatGPT แก้หรือหยุดแจ้งเหตุผล จึงไม่รับประกันว่าทุกโจทย์จะจบได้ด้วยข้อความเดียว เมื่อได้คลิปแล้วต้องตรวจภาพและเสียงก่อนนำไปใช้ การโพสต์คลิปและปักตะกร้าทำด้วยตัวเอง
