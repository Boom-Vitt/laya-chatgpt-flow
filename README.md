...
**สถานะ: รุ่นทดลอง — Laya ทำ pilot 8 วินาทีได้ และ ChatGPT Work ทำ baseline แรก 16 วินาทีได้แล้ว แต่ยังรอ QC ภาพ/เสียงและยังไม่มีผลเทียบครบ 6 คลิป** ผลตรวจและตัวเลขที่วัดได้อยู่ใน [results](results/README.md) ยังสรุปการประหยัด token หรือเวลาไม่ได้
